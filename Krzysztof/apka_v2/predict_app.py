from models_module import MLModels
...
def apply_kmeans_heart_based(df):
    ...
    if df is not None:
        ...
        standardized_data = ml_models.scale_data(df[available_features].dropna())

        clusters = ml_models.cluster_data(standardized_data)
